...
theorem datatypeTesterFirstSeed_smtVCsCorrect : Strata.smtVCsCorrectBoole datatypeTesterFirstSeed := by
  gen_smt_vcs_boole
  all_goals (first | smt | smt +mono)
...
theorem datatypeTesterSecondSeed_smtVCsCorrect : Strata.smtVCsCorrectBoole datatypeTesterSecondSeed := by
  gen_smt_vcs_boole
  all_goals (first | smt | smt +mono)
...
theorem datatypeTesterWithGlobalSeed_smtVCsCorrect : Strata.smtVCsCorrectBoole datatypeTesterWithGlobalSeed := by
  gen_smt_vcs_boole
  all_goals (first | smt | smt +mono)
...
Obligation: assert_2_4496
Property: assert
Result: ✅ pass

Obligation: assert_3_4527
Property: assert
Result: ✅ pass

Obligation: test_parity_ensures_0_4428
Property: assert
Result: ✅ pass

Obligation: test_parity_ensures_1_4460
Property: assert
Result: ✅ pass-/
#guard_msgs in
#eval Strata.Boole.verify "cvc5" recfndefsMultiSeed (options := .quiet)

theorem recfndefsMultiSeed_smtVCsCorrect : Strata.smtVCsCorrectBoole recfndefsMultiSeed := by
  gen_smt_vcs_boole
