...
theorem b_completeness (φ : Proposition Atom)
  ...
  have h_cons : SetConsistent (@BAxiom Atom)
    ...
    have efq_ax : DerivationTree (@BAxiom Atom) (Atom := Atom) []
        (Proposition.bot.imp φ) :=
      .ax [] _ (.efq φ)
    have ik : DerivationTree (@BAxiom Atom) (Atom := Atom) []
    ...
    have is_ax : DerivationTree (@BAxiom Atom) (Atom := Atom) []
    ...
    have peirce_ax : DerivationTree (@BAxiom Atom) (Atom := Atom) []
