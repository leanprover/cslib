...
singleton domain).
-/
noncomputable def singleton_chronicle (A : Set (Formula Atom)) : Chronicle Atom :=
  { f := fun _ => A
    g := fun _ _ => ∅
    dom := {(0 : Rat)} }
...
-/
noncomputable def omega_chain (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A) :
...
-/
noncomputable def omega_chain_val (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
...
-/
noncomputable def omega_chain_elim_result (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
...
-/
noncomputable def limit_dom (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
    :
    Set Rat :=
...
-/
noncomputable def limit_f (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
    :
...
theorem limit_c0 (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
    ...
    Temporal.SetMaximalConsistent (limit_f A h_mcs x) := by
  obtain ⟨n, hn⟩ := hx
...
theorem limit_F_resolution (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
    (x : Rat) (hx : x ∈ limit_dom A h_mcs)
    (φ : Formula Atom)
    (h_F : Formula.someFuture φ ∈ limit_f A h_mcs x) :
...
theorem limit_P_resolution (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
    (x : Rat) (hx : x ∈ limit_dom A h_mcs)
    (φ : Formula Atom)
    (h_P : Formula.somePast φ ∈ limit_f A h_mcs x) :
...
-/
noncomputable def limit_g (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
    :
...
theorem limit_forward_G (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
    (x y : Rat) (hx : x ∈ limit_dom A h_mcs) (hy : y ∈ limit_dom A h_mcs)
    (hxy : x < y) (φ : Formula Atom) (h_G : Formula.allFuture φ ∈ limit_f A h_mcs x) :
...
theorem limit_backward_H (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
    (x y : Rat) (hx : x ∈ limit_dom A h_mcs) (hy : y ∈ limit_dom A h_mcs)
    (hyx : y < x) (φ : Formula Atom) (h_H : Formula.allPast φ ∈ limit_f A h_mcs x) :
    φ ∈ limit_f A h_mcs y := by
  by_contra h_not
  have h_mcs_x := limit_c0 A h_mcs x hx
  have h_mcs_y := limit_c0 A h_mcs y hy
...
private theorem adj_g_mem_f_at_stage (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A) :
    ∀ (d : Nat) (n : Nat) (a b : Rat),
...
theorem adj_g_mem_limit_f (A : Set (Formula Atom)) (h_mcs : Temporal.SetMaximalConsistent A)
    ...
    (φ : Formula Atom) (hφ : φ ∈ (omega_chain_val A h_mcs k).g a b)
